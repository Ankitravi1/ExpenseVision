...
interface DataContextValue {
    ...
    setBudget: (b: { categoryId: string; amount: number; month?: string }) => Promise<void>;
...
export const DataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const setBudget = useCallback(async (b: { categoryId: string; amount: number; month?: string }) => {
    ...
    return (
        <DataContext.Provider
            value={{
                accounts, categories, transactions, budgets, isLoading, error, refresh,
