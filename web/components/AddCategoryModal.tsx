                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
                        <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all ${type === 'expense' ? 'bg-white dark:bg-gray-600 shadow text-primary' : 'text-gray-500'}`}
                            >
                                Expense
                            </button>
                            <button
                                ...
                                className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all ${type === 'income' ? 'bg-white dark:bg-gray-600 shadow text-primary' : 'text-gray-500'}`}
                            >
                                Income
                            </button>
                        </div>
